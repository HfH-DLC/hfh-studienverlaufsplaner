<template>
    ...
    <div class="p-4 max-w-6xl mx-auto">
        ...
        <p>
            Unabhängig vom StVPl müssen Sie ihre Module offiziell in
            daylight-Web buchen. Sie erhalten eine separate Info per Mail von
            der Hochschuladministration.
        </p>
                ...
                <div>
                    <form @submit.prevent="createPlan" class="mt-4 w-64">
                        ...
                        <input
                            ...
                            id="email"
                            required
                            class="leading-4 w-full block border border-gray-600 rounded shadow-inner p-2"
                        />
            ...
            <div>
                ...
                <div>
                    <form @submit.prevent="viewPlan" class="mt-4 w-64">
                        <label for="slug" class="text-sm uppercase"
                            >Plan-Nummer</label
                        >
                        <input
                            type="text"
